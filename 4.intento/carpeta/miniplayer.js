(function(g){var window=this;'use strict';var Dpb=function(a,b){g.U.call(this,{I:"button",Ma:["ytp-miniplayer-expand-watch-page-button","ytp-button","ytp-miniplayer-button-top-left"],W:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button","aria-keyshortcuts":"i","data-title-no-tooltip":"{{data-title-no-tooltip}}"},V:[{I:"svg",W:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},V:[{I:"g",W:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},V:[{I:"g",W:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},
V:[{I:"path",W:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.J=a;this.Ta("click",this.onClick,this);this.updateValue("title",g.hU(a,"Expandir","i"));this.update({"data-title-no-tooltip":"Expandir"});this.addOnDisposeCallback(g.fU(b.qc(),this.element))},Epb=function(a){g.U.call(this,
{I:"div",
S:"ytp-miniplayer-ui"});this.jg=!1;this.player=a;this.T(a,"minimized",this.uh);this.T(a,"onStateChange",this.UR)},Fpb=function(a){g.xV.call(this,a);
this.B=new g.OK(this);this.j=new Epb(this.player);this.j.hide();g.sU(this.player,this.j.element,4);a.pg()&&(this.load(),g.Nu(a.getRootNode(),"ytp-player-minimized",!0))};
g.w(Dpb,g.U);Dpb.prototype.onClick=function(){this.J.Qa("onExpandMiniplayer")};g.w(Epb,g.U);g.k=Epb.prototype;
g.k.FO=function(){this.tooltip=new g.SX(this.player,this);g.L(this,this.tooltip);g.sU(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Uc=new g.dW(this.player);g.L(this,this.Uc);this.vk=new g.U({I:"div",S:"ytp-miniplayer-scrim"});g.L(this,this.vk);this.vk.Ea(this.element);this.T(this.vk.element,"click",this.xJ);var a=new g.U({I:"button",Ma:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Cerrar"},V:[g.nG()]});g.L(this,a);a.Ea(this.vk.element);this.T(a.element,"click",this.Op);
a=new Dpb(this.player,this);g.L(this,a);a.Ea(this.vk.element);this.uv=new g.U({I:"div",S:"ytp-miniplayer-controls"});g.L(this,this.uv);this.uv.Ea(this.vk.element);this.T(this.uv.element,"click",this.xJ);var b=new g.U({I:"div",S:"ytp-miniplayer-button-container"});g.L(this,b);b.Ea(this.uv.element);a=new g.U({I:"div",S:"ytp-miniplayer-play-button-container"});g.L(this,a);a.Ea(this.uv.element);var c=new g.U({I:"div",S:"ytp-miniplayer-button-container"});g.L(this,c);c.Ea(this.uv.element);this.CZ=new g.eX(this.player,
this,!1);g.L(this,this.CZ);this.CZ.Ea(b.element);b=new g.dX(this.player,this);g.L(this,b);b.Ea(a.element);this.nextButton=new g.eX(this.player,this,!0);g.L(this,this.nextButton);this.nextButton.Ea(c.element);this.Hj=new g.LX(this.player,this);g.L(this,this.Hj);this.Hj.Ea(this.vk.element);this.Qc=new g.jX(this.player,this);g.L(this,this.Qc);g.sU(this.player,this.Qc.element,4);this.gJ=new g.U({I:"div",S:"ytp-miniplayer-buttons"});g.L(this,this.gJ);g.sU(this.player,this.gJ.element,4);a=new g.U({I:"button",
Ma:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Cerrar"},V:[g.nG()]});g.L(this,a);a.Ea(this.gJ.element);this.T(a.element,"click",this.Op);a=new g.U({I:"button",Ma:["ytp-miniplayer-replay-button","ytp-button"],W:{"aria-label":"Cerrar"},V:[g.Dva()]});g.L(this,a);a.Ea(this.gJ.element);this.T(a.element,"click",this.U9);this.T(this.player,"presentingplayerstatechange",this.Sd);this.T(this.player,"appresize",this.Ib);this.T(this.player,"fullscreentoggled",this.Ib);this.Ib()};
...
g.k.qp=function(){};
g.k.Zw=function(){};
g.k.LH=function(){return null};g.w(Fpb,g.xV);g.k=Fpb.prototype;g.k.onVideoDataChange=function(){if(this.player.getVideoData()){var a=this.player.getVideoAspectRatio(),b=16/9;a=a>b+.1||a<b-.1;g.Nu(this.player.getRootNode(),"ytp-rounded-miniplayer-not-regular-wide-video",a)}};
